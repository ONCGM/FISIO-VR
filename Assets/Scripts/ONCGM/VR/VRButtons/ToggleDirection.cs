...
namespace ONCGM.VR.VRButtons {
    public class ToggleDirection : GameWorldButton {
        [Header("OnClick Settings")]
        [SerializeField] protected OnClickEvent onClickHandler = new OnClickEvent();
        [Header("Text Settings")] 
        [SerializeField] protected string textToDisplayBeforeState = "Direção: ";
        ...
        /// </summary>
        private SpawnDirection toggleState = SpawnDirection.All;
        
        /// <summary>
        /// The state of the toggle button.
        /// </summary>
        public SpawnDirection ToggleState {
            get => toggleState;
            set {
        ...
        protected virtual void Awake() {
            ...
            ToggleState = GameManager.CurrentSettings.DirectionsToSpawnObjects;
            UpdateState();
        }
