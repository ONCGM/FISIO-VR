...
namespace ONCGM.VR.VRButtons {
    /// <summary>
    /// Toggles the game difficulty like a circular switch.
    /// </summary>
    public class ToggleGameDifficulty : GameWorldButton {
        [Header("OnClick Settings")]
        [SerializeField] protected OnClickEvent onClickHandler = new OnClickEvent();
        [Header("Text Settings")] 
        [SerializeField] protected string textToDisplayBeforeState = "Dificuldade: ";
        ...
        /// </summary>
        private GameDifficulty toggleState = GameDifficulty.Normal;
        
        /// <summary>
        /// The state of the toggle button.
        /// </summary>
        public GameDifficulty ToggleState {
            get => toggleState;
            set {
        ...
        protected virtual void Awake() {
            ...
            ToggleState = GameManager.CurrentSettings.GameDifficulty;
            UpdateState();
        }
        ...
        protected virtual void UpdateState() {
            AnimateClick();
            uiText.text = string.Concat(textToDisplayBeforeState, Environment.NewLine, GameDifficultyExtension.ToString(ToggleState));
        }
