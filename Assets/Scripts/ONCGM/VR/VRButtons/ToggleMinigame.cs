...
namespace ONCGM.VR.VRButtons {
    public class ToggleMinigame : GameWorldButton {
        [Header("OnClick Settings")] [SerializeField]
        protected OnClickEvent onClickHandler = new OnClickEvent();

        [Header("Text Settings")] [SerializeField]
        protected string textToDisplayBeforeState = "Minijogo(s): ";

        [Header("Animation Settings")] [SerializeField]
        protected Vector3 animationStrength = Vector3.zero;
        ...
        /// </summary>
        private Minigames toggleState = Minigames.All;

        /// <summary>
        /// The state of the toggle button.
        /// </summary>
        public Minigames ToggleState {
            get => toggleState;
            set {
        ...
        protected virtual void Awake() {
            ...
            ToggleState = GameManager.CurrentSettings.MinigamesToIncludeInSession;
            UpdateState();
        }
        ...
        protected virtual void UpdateState() {
            AnimateClick();
            uiText.text = string.Concat(textToDisplayBeforeState, Environment.NewLine,
