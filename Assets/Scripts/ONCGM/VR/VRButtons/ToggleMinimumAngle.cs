...
namespace ONCGM.VR.VRButtons {
    /// <summary>
    /// Toggles the minimum angle settings back and forth between all possible values.
    /// </summary>
    public class ToggleMinimumAngle : GameWorldButton {
        [Header("OnClick Settings")]
        [SerializeField] protected OnClickEvent onClickHandler = new OnClickEvent();
        [Header("Text Settings")] 
        [SerializeField] protected string textToDisplayBeforeState = "Angulo Mínimo: ";
        ...
        protected virtual void Awake() {
            ...
            ToggleState = GameManager.CurrentSettings.MinimumAngle;
            UpdateState();
        }
        ...
        protected virtual void UpdateState() {
            AnimateClick();
            uiText.text = string.Concat(textToDisplayBeforeState, Environment.NewLine, ToggleState.ToString(CultureInfo.InvariantCulture), " Graus");
        }
