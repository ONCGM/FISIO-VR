...
namespace ONCGM.VR.VRButtons {
    public class ToggleObject : GameWorldButton {
        [Header("OnClick Settings")]
        [SerializeField] protected OnClickEvent onClickHandler = new OnClickEvent();
        [Header("Text Settings")] 
        [SerializeField] protected string textToDisplayBeforeState = "Objetos: ";
        ...
        /// </summary>
        private SpawnObjectsCatchGame toggleState = SpawnObjectsCatchGame.All;
        
        /// <summary>
        /// The state of the toggle button.
        /// </summary>
        public SpawnObjectsCatchGame ToggleState {
            get => toggleState;
            set {
        ...
        protected virtual void Awake() {
            ...
            ToggleState = GameManager.CurrentSettings.TypesOfObjectsToSpawn;
            UpdateState();
        }
        ...
        protected virtual void UpdateState() {
            AnimateClick();
            uiText.text = string.Concat(textToDisplayBeforeState, Environment.NewLine, SpawnObjectsCatchGameExtension.ToString(ToggleState));
        }
